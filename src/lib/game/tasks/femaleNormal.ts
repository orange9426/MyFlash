...
// 原始正文和需求在同一个任务对象中配置。
export const femaleNormalTasks: TaskPools = {
  "楼层任务": [
    {
      "id": "A1",
      "name": "舔脏袜",
    ...
    },
    {
      "id": "A4",
      "name": "短袜自慰",
      "description": "短袜捂住逼，摩擦至少30s，不准高潮",
      "baseScore": 2,
      "needs": {
        "requireAll": [
          "短袜"
    ...
    },
    {
      "id": "A7",
      "name": "墙角磨逼",
      "description": "面对墙角，逼紧贴墙面前后摩擦至少30下，边蹭边轻喘",
      "baseScore": 2,
      "needs": {
        "wear": {
          "长裤": "off",
    ...
    },
    {
      "id": "A8",
      "name": "短袜捂逼",
      "description": "把脱下的短袜捂在逼上夹住，保持至少1分钟，期间不能用手",
      "baseScore": 2,
      "needs": {
        "requireAll": [
          "短袜"
    ...
    },
    {
      "id": "A11",
      "name": "冷风吹逼",
      "description": "打开楼道窗（若有）或对着通风口，逼完全露在风里至少2分钟",
      "baseScore": 2,
      "needs": {
        "wear": {
          "长裤": "off",
    ...
    },
    {
      "id": "A12",
      "name": "镜面摩擦",
      "description": "逼在防火门上轻轻蹭，蹭出至少3条水痕",
      "baseScore": 2,
      "needs": {
        "wear": {
          "长裤": "off",
    ...
    },
    {
      "id": "A13",
      "name": "轻度憋尿展示",
      "description": "憋到有感觉，楼梯转角蹲下，用尿在地面画一个小圈",
      "baseScore": 2,
      "urineBonus": 1,
      "needs": {
        "wear": {
    ...
    },
    {
      "id": "A16",
      "name": "跪尿",
      "description": "跪下把逼贴在台阶上，慢慢尿出一小段，用舌头把台阶舔干净",
      "baseScore": 3,
      "urineBonus": 2,
      "needs": {
        "kneeling": true,
    ...
    },
    {
      "id": "A19",
      "name": "沉默忍耐",
      "description": "自己轻轻捏住乳头或阴蒂，完全不出声至少1分钟",
      "baseScore": 1,
      "needs": {}
    },
    {
      "id": "A20",
      "name": "边缘低语",
      "description": "边揉边对着墙缝低声说「我是暴露的母狗」，至少重复10次",
      "baseScore": 2,
      "needs": {
        "sound": true
      }
    ...
    },
    {
      "id": "A26",
      "name": "影子展示",
      "description": "借楼道灯光，双腿打开摆出夸张影子，拍下来",
      "baseScore": 2,
      "needs": {
        "photo": true
      }
    ...
    },
    {
      "id": "A30",
      "name": "温度对比",
      "description": "冰凉金属扶手贴住阴蒂，保持至少20s",
      "baseScore": 2,
      "needs": {}
    },
    {
    ...
    },
    {
      "id": "A32",
      "name": "最后一滴",
      "description": "逼上残留的水，用手指抹到嘴唇上，完成后才算过",
      "baseScore": 2,
      "needs": {}
    },
    {
      "id": "A33",
      "name": "夹奶行走",
      "description": "上衣卷起，双手托住或夹紧奶子，走完本层转角",
      "baseScore": 2,
      "needs": {
        "wear": {
          "上衣": "rolled"
    ...
    },
    {
      "id": "A34",
      "name": "内裤勒缝",
      "description": "内裤勒进逼缝，原地慢慢蹲起至少10次",
      "baseScore": 2,
      "needs": {
        "requireAll": [
          "内裤"
    ...
    },
    {
      "id": "B2",
      "name": "模拟被操",
      "description": "光屁股面对墙，往墙上撞至少3下，边撞边揉，模拟被操",
      "baseScore": 3,
      "needs": {
        "wear": {
          "长裤": "off",
    ...
    },
    {
      "id": "B3",
      "name": "掰穴露出",
      "description": "掰开逼露出阴蒂和穴口，拍至少3张不同角度",
      "baseScore": 2,
      "needs": {
        "wear": {
          "长裤": "off",
    ...
    },
    {
      "id": "B4",
      "name": "夹腿露出",
      "description": "脱下内裤勒进逼缝，夹腿，保持至少1分钟",
      "baseScore": 2,
      "needs": {
        "requireAll": [
          "内裤"
    ...
    },
    {
      "id": "B9",
      "name": "双腿大开",
      "description": "坐在台阶上双腿完全打开，逼朝向可能有人下来的方向，保持至少2分钟",
      "baseScore": 3,
      "needs": {
        "wear": {
          "长裤": "off",
    ...
    },
    {
      "id": "B11",
      "name": "台阶排尿",
      "description": "选一级台阶，蹲着对准台阶边缘慢慢尿，至少尿湿半级",
      "baseScore": 3,
      "urineBonus": 2,
      "needs": {
        "wear": {
    ...
    },
    {
      "id": "B17",
      "name": "倒计时挑战",
      "description": "倒计时至少2分钟，期间完成「脱内裤→揉20下→再穿上」循环至少3次",
      "baseScore": 3,
      "needs": {
        "requireAll": [
          "内裤"
    ...
    },
    {
      "id": "B20",
      "name": "轻打逼",
      "description": "手掌轻轻拍打逼和阴蒂各至少10下，要拍出声音",
      "baseScore": 2,
      "needs": {}
    },
    {
      "id": "B21",
      "name": "夹紧忍耐",
      "description": "双腿把逼紧紧夹住至少1分钟，期间不能用手碰",
      "baseScore": 2,
      "needs": {}
    },
    {
      "id": "B22",
      "name": "乳头拉扯",
      "description": "用力拉扯两边乳头，同时保持湿润至少30s",
      "baseScore": 2,
      "needs": {
        "wear": {
          "上衣": "rolled"
    ...
    },
    {
      "id": "B29",
      "name": "寸止一次",
      "description": "揉到即将高潮时强制停下，冷静至少30s再继续",
      "baseScore": 3,
      "needs": {}
    },
    {
    ...
    },
    {
      "id": "B31",
      "name": "边缘低语升级",
      "description": "边边缘边大声说「请路过的主人看母狗逼」，至少重复8次",
      "baseScore": 3,
      "needs": {
        "sound": true
      }
    ...
    },
    {
      "id": "B34",
      "name": "温度刺激",
      "description": "楼道里较凉的金属，交替刺激阴蒂与乳头",
      "baseScore": 2,
      "needs": {}
    },
    {
    ...
    },
    {
      "id": "B37",
      "name": "奶子贴墙",
      "description": "上衣卷起，两奶紧贴冷墙左右摩擦至少30下",
      "baseScore": 2,
      "needs": {
        "wear": {
          "上衣": "rolled"
    ...
    },
    {
      "id": "B38",
      "name": "蹲姿守候",
      "description": "转角蹲着，双腿打开露逼，坚持至少2分钟",
      "baseScore": 3,
      "needs": {
        "wear": {
          "长裤": "off",
    ...
    },
    {
      "id": "C2",
      "name": "逼贴地走",
      "description": "穿短袜，蹲着走让逼贴近台阶，屁股大幅扭动至少3米",
      "baseScore": 3,
      "needs": {
        "requireAll": [
          "短袜"
    ...
    },
    {
      "id": "C3",
      "name": "超长跪姿暴露",
      "description": "逼朝楼下，跪下至少10分钟，穴口露着不能挡",
      "baseScore": 4,
      "needs": {
        "wear": {
          "长裤": "off",
    ...
    },
    {
      "id": "C10",
      "name": "转角守候升级",
      "description": "转角全裸，逼朝向可能来人的方向，坚持至少4分钟",
      "baseScore": 4,
      "needs": {
        "wear": {
          "上衣": "off",
    ...
    },
    {
      "id": "C11",
      "name": "完整排尿展示",
      "description": "楼梯中间蹲着，整泡尿全部尿在台阶上，过程录下来",
      "baseScore": 4,
      "urineBonus": 3,
      "needs": {
        "wear": {
    ...
    },
    {
      "id": "C12",
      "name": "尿后全身标记",
      "description": "用自己的尿在胸口、大腿、逼上各画一条线",
      "baseScore": 3,
      "urineBonus": 2,
      "needs": {
        "urine": true
    ...
    },
    {
      "id": "C20",
      "name": "轻打升级",
      "description": "用手或衣物轻轻抽打逼和屁股各至少15下",
      "baseScore": 3,
      "needs": {}
    },
    {
      "id": "C21",
      "name": "强制边缘三次",
      "description": "连续三次揉到高潮边缘再强制停下，每次间隔至少40s",
      "baseScore": 4,
      "needs": {}
    },
    {
    ...
    },
    {
      "id": "C25",
      "name": "整层标记",
      "description": "本层至少三个不同位置留下尿液或淫水痕迹",
      "baseScore": 4,
      "urineBonus": 3,
      "needs": {
        "urine": true
    ...
    },
    {
      "id": "C27",
      "name": "通风口长时间",
      "description": "逼长时间对着通风口，气流持续刺激至少3分钟",
      "baseScore": 3,
      "needs": {
        "wear": {
          "长裤": "off",
    ...
    },
    {
      "id": "C30",
      "name": "淫水大量收集",
      "description": "尽可能多挤出淫水，全部涂在脸上或胸口",
      "baseScore": 3,
      "needs": {}
    },
    {
      "id": "C31",
      "name": "边缘宣言",
      "description": "边边缘边大声重复「我是楼道里的暴露母狗」至少15次",
      "baseScore": 3,
      "needs": {
        "sound": true
      }
    },
    {
      "id": "C32",
      "name": "连续高难度",
      "description": "先做一次超长跪姿，紧接着立刻逼贴地走",
      "baseScore": 4,
      "needs": {
        "requireAll": [
          "短袜"
    ...
    },
    {
      "id": "C38",
      "name": "尿液边缘",
      "description": "边缘状态下往逼上滴几滴尿，然后继续边缘",
      "baseScore": 4,
      "urineBonus": 2,
      "needs": {
        "urine": true
    ...
    },
    {
      "id": "C40",
      "name": "终极展示",
      "description": "全裸、双手掰开逼，面对可能来人的方向站着，坚持到自己主动停（最长5分钟）",
      "baseScore": 4,
      "needs": {
        "wear": {
          "上衣": "off",
    ...
    },
    {
      "id": "C41",
      "name": "潮吹边缘",
      "description": "连续刺激到快喷出来再强制停下至少2次",
      "baseScore": 4,
      "needs": {}
    },
    {
  ...
  "上楼任务": [
    ...
    },
    {
      "id": "U6",
      "name": "赤脚上楼",
      "description": "赤脚慢走，每一步停至少0.5s，露出逼",
      "baseScore": 2,
      "needs": {
        "wear": {
          "短袜": "off",
    ...
    },
    {
      "id": "U31",
      "name": "奶子晃上楼",
      "description": "上衣卷起或不穿上衣，上楼时故意让奶子明显晃动",
      "baseScore": 2,
      "needs": {
        "wear": {
          "上衣": "rolled"
