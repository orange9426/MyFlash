...
// 原始正文和需求在同一个任务对象中配置。
export const maleNormalTasks: TaskPools = {
  "楼层任务": [
    {
      "id": "MN1",
      "name": "舔脏袜",
    ...
    },
    {
      "id": "MN10",
      "name": "靠墙俯卧撑",
      "description": "面对墙壁，进行墙卧撑20次，胸部需要贴到墙面",
      "baseScore": 1,
      "needs": {
        "wear": {
          "上衣": "off"
    ...
    },
    {
      "id": "MN15",
      "name": "表示歉意",
      "description": "把上衣挂在邻居门把手上，在门前土下座",
      "baseScore": 2,
      "needs": {
        "requireAll": [
          "上衣"
